# GPU-accelerated development script for MeetOdds (Windows PowerShell)
# Automatically detects and runs in development mode with optimal GPU features

Write-Host "GPU-Accelerated Development Mode for MeetOdds" -ForegroundColor Blue
Write-Host ""
...
Write-Host ""
Write-Host "Starting MeetOdds in development mode..." -ForegroundColor Blue
Write-Host ""
