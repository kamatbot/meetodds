...
// Global language preference storage (default to automatic detection in the original language)
...
pub fn run() {
    ...
    builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            api::api_list_meetings,
            api::api_refresh_meeting_intelligence,
            api::api_get_meeting_intelligence,
            api::api_save_meeting_context,
            api::api_set_meeting_fact_confirmed,
            api::api_dismiss_meeting_fact,
            api::api_update_meeting_action,
            api::api_get_action_inbox,
            api::api_generate_followup_draft,
            api::api_search_meeting_memory,
            api::api_get_meeting_preparation,
            api::api_rename_meeting,
            ...
            api::api_list_moment_notes,
            api::api_create_moment_note,
            api::api_save_moment_note,
            api::api_get_moment_notes_summary,
            api::api_save_manual_notes_checked,
            api::open_moment_note_source,
            manual_notes_window::open_manual_notes_window,
            manual_notes_window::close_manual_notes_window,
            manual_notes_window::get_manual_notes_window_target,
            manual_notes_window::toggle_manual_notes_fullscreen,
