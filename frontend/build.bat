@echo off
REM MeetOdds Build Script for Windows
...
echo 🚀 Building MeetOdds application...
...
echo.
echo ========================================
echo    MeetOdds Build Script - Help
echo ========================================
echo.
echo USAGE:
...
echo.
echo DESCRIPTION:
echo   This script builds the MeetOdds Tauri application for Windows.
